"""
Django settings for kanri_pj project.
...
SECRET_KEY = 'django-insecure-bv8d741qb066#(ya8jgil_hir1cj+hll_e_pynf-2hnc8ezon&'
...
WSGI_APPLICATION = 'kanri_pj.wsgi.application'
